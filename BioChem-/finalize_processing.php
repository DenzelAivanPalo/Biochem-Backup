...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    try {
        foreach ($employeeData as $employee) {
            ...
            $emppID = $employee['patient_id'];
            $empAppDate = $employee['appointment_date'];
            $empAppTime = $employee['appointment_time'];
            $empID = $employee['id'];
        ...
        echo "<script>window.location.href = 'processing_confirmation.php';</script>";
        ...
        echo "window.location.href = 'front_desk_dashboard.php';
        </script>";
    }
}
?> 